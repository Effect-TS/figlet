...
/**
 * Converts a `FigCharacter` into `SubColumns`.
 */
...
function validateEndmark(
  ...
  return E.chain_(
    extractedEndmarksV,
    A.foldLeft<string, FigletResult<string>>(
      () =>
        E.left(
          NA.single(
            new FigCharacterError({
...
export const equalFigCharacter: Equal<FigCharacter> = Eq.makeEqual(Structural.equals)
