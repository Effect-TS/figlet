...
function layoutToMergeStrategy_(
  ...
  return matchTag_(layout, {
    FullWidth: () => fullWidthStrategy,
    HorizontalFitting: () => horizontalFittingStrategy,
    UniversalSmushing: () => universalHorizontalSmushingStrategy(hardblank),
    ControlledSmushing: (_) => controlledHorizontalSmushingStrategy(hardblank, _.rules)
  })
}
...
function ruleToSmushingStrategy(hardblank: string) {
  return matchTag({
    EqualCharacter: () => equalCharacterSmushingRule(hardblank),
    Underscore: () => underscoreSmushingRule,
    Hierarchy: () => hierarchySmushingRule,
    OppositePair: () => oppositePairSmushingRule,
    BigX: () => bigXSmushingRule,
    Hardblank: () => hardblankSmushingRule(hardblank)
  })
}
